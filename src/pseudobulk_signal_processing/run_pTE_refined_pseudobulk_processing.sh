...
FRAGMETSTSV=/groups/stark/nikolaus.mandlburger/Projects/blastoid_project/blastoid_DL_modelling/data/pTE_refined/fragments.tsv.gz
OUT_BW=/groups/stark/nikolaus.mandlburger/Projects/blastoid_project/blastoid_DL_modelling/res/pseudobulks/pTE_refined/pTE_96h_rpm_norm.bw
