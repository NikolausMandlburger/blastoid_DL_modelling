...
BW=/groups/stark/nikolaus.mandlburger/Projects/blastoid_project/blastoid_DL_modelling/res/pseudobulks/overall_blastoid/overall_cells_96h_rpm_norm.bw
...
OUTDIR=/groups/stark/nikolaus.mandlburger/Projects/blastoid_project/blastoid_DL_modelling/res/pseudobulks/overall_blastoid
